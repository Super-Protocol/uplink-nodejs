      ...
      'targets':[
        {
          ...
          "sources":["./libUplink.cc", "./functions/promises_execute.cc", "./functions/promises_complete.cc", "./common/project_operations.cc", "./common/download_operations.cc", "./commmon/upload_operations.cc", "./common/access_operations.cc", "./common/bucket_operations.cc", "./common/object_operations.cc", "./common/release_objects_helpers.cc"],
        ...
        'targets':[
          {
            ...
            "sources":["./libUplink.cc", "./functions/promises_execute.cc", "./functions/promises_complete.cc", "./common/project_operations.cc", "./common/download_operations.cc", "./functions/upload_operations.cc", "./common/access_operations.cc", "./common/bucket_operations.cc", "./common/object_operations.cc", "./common/release_objects_helpers.cc"],
            "link_settings": {
              "libraries":["-L/<(module_root_dir)", "-luplinkcv1.7.0-sp"],
            },
            "cxxflags":["-fPIC"],
